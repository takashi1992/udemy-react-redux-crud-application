...
class EventsShow extends Component {
  ...
  render(){
    ...
    const style = {margin: 12, wirth: '100%'}
    return (
      <form onSubmit={handleSubmit(this.onSubmit)}>
        ...
        <Link to="/"><Button variant="contained" style={style}>Cancel</Button></Link>
        <Button variant="contained" style={style} onClick={this.onDeleteClick}>Delete</Button>
      </form>
    )
  }
}
